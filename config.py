...
if __name__ == "__main__":
    conf = Config()
    print(conf.get("FILE_DATA").train_wav_path)
    print(conf.get("FILE_DATA").train_label_file)
    print(conf.get("FILE_DATA").test_wav_path)
    print(conf.get("FILE_DATA").test_label_file)
